...
def training(trainingimages, traininglabels,epochs, learning_rate, output_size, hidden_1_size, hidden_2_size, weights_1, weights_2, weights_3, biases_1, biases_2, biases_3):
    ...
    for epoch in range(epochs):
        ...
        for i in range(5000): #goes over every image
...
def save(weights_1, weights_2, weights_3, biases_1, biases_2, biases_3):
    with open('manual_NN_numbers_weights_1_testing.txt', 'w') as file:
        json.dump(weights_1, file)

    with open('manual_NN_numbers_weights_2_testing.txt', 'w') as file:
        json.dump(weights_2, file)

    with open('manual_NN_numbers_weights_3_testing.txt', 'w') as file:
        json.dump(weights_3, file)
    
    with open('manual_NN_numbers_biases_1_testing.txt', 'w') as file:
        json.dump(biases_1, file)

    with open('manual_NN_numbers_biases_2_testing.txt', 'w') as file:
        json.dump(biases_2, file)
    
    with open('manual_NN_numbers_biases_3_testing.txt', 'w') as file:
        json.dump(biases_3, file)

def load(weights_1, weights_2, weights_3, biases_1, biases_2, biases_3):
    with open('manual_NN_numbers_weights_1.txt', 'r') as file:
        weights_1 = json.load(file)

    with open('manual_NN_numbers_weights_2.txt', 'r') as file:
        weights_2 = json.load(file)

    with open('manual_NN_numbers_weights_3.txt', 'r') as file:
        weights_3 = json.load(file)
    
    with open('manual_NN_numbers_biases_1.txt', 'r') as file:
        biases_1 = json.load(file)

    with open('manual_NN_numbers_biases_2.txt', 'r') as file:
        biases_2 = json.load(file)
    
    with open('manual_NN_numbers_biases_3.txt', 'r') as file:
